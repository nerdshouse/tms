...
const PRIORITIES: { value: Priority; label: string; color: string }[] = [
  ...
  { value: "P1", label: "P1 — High",     color: "text-amber-600" },
  { value: "P2", label: "P2 — Normal",   color: "text-blue-600" },
];
    ...
    <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl p-6 space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Describe the issue or feature request in detail. Include steps to reproduce for bugs."
          required
          rows={5}
        ...
        <div
          ...
          className={`border-2 border-dashed rounded-lg p-5 text-center cursor-pointer transition-colors ${
            isDragActive
              ...
              : "border-border hover:border-accent/50 hover:bg-gray-50/50"
          }`}
        >
          <input {...getInputProps()} />
      ...
      <div className="flex items-center gap-3 pt-1">
        ...
        <button
          type="button"
          onClick={() => router.back()}
          className="px-4 py-2 text-[13px] text-muted hover:text-foreground border border-border rounded-lg hover:bg-gray-50 transition"
        >
          Cancel
        </button>
      </div>
